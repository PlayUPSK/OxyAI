    ...
    public function getInstructions(): array
    {
        return [
            ...
            'rules' => [
                ...
                'Use the css field as the authoritative fallback for component CSS. Native Oxygen design properties improve editability for supported properties, but plain Oxygen Container/Text/Image elements in Oxygen 6 / Breakdance Oxygen still need class CssCode for reliable frontend rendering.',
                'Only remove source CssCode for element types whose list_oxygen_element_capabilities response has cssFallbackCanBeStripped=true; keep base class CSS for Container/Text even when native design properties are populated.',
                ...
                'For MCP page writes, leave registerSelectors enabled unless the user explicitly asks for raw runtime classes only. This attaches semantic classes into meta.classes so they can continue to be selected and managed from the Oxygen editor.',
